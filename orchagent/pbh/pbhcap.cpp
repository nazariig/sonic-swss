...
template<typename T>
static inline std::string toStr(T value) noexcept;

template<>
inline std::string toStr(PbhAsicVendor value) noexcept
{
...
template<>
inline std::string toStr(PbhFieldCapability value) noexcept
{
...
static inline std::string toStr(const std::set<PbhFieldCapability> &value) noexcept
{
    std::stringstream ss;
...
//void PbhCapabilities::pushCapab()
//{
//
//}


    //std::string platform1 = std::getenv("ASIC_VENDOR") ? std::getenv("ASIC_VENDOR") : "";
    //SWSS_LOG_NOTICE("Platform environment variable: ASIC_VENDOR=%s", platform1.c_str());

    //std::string platform2 = std::getenv("platform") ? std::getenv("platform") : "";
    //SWSS_LOG_NOTICE("Platform environment variable: platform=%s", platform2.c_str());
    ...
    //{
   //this->filedCap->table.interface_list
    //}
